...
### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-148">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-148">Applicable Attributes</span></span>
...
<span data-ttu-id="79f6b-178">任何屬性都適用於**CommandText**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-178">No attributes are applicable to the **CommandText** element.</span></span>
...
<span data-ttu-id="79f6b-188">您可以使用 Entity Framework 中的預存程序，可透過檢視的讀寫案例。</span><span class="sxs-lookup"><span data-stu-id="79f6b-188">You can use stored procedures in the Entity Framework to enable read-write scenarios over views.</span></span> <span data-ttu-id="79f6b-189">您可以使用資料來源檢視或 Entity SQL 檢視的基底資料表擷取資料及進行變更處理預存程序。</span><span class="sxs-lookup"><span data-stu-id="79f6b-189">You can use either a data source view or an Entity SQL view as the base table for retrieving data and for change processing by stored procedures.</span></span>
...
<span data-ttu-id="79f6b-203">下表描述可套用至的屬性**相依**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-203">The following table describes the attributes that can be applied to the **Dependent** element.</span></span>
...
<span data-ttu-id="79f6b-217">**文件**存放結構定義語言 (SSDL) 中的項目可以用來提供父元素中定義之物件的相關資訊。</span><span class="sxs-lookup"><span data-stu-id="79f6b-217">The **Documentation** element in store schema definition language (SSDL) can be used to provide information about an object that is defined in a parent element.</span></span>
...
| <span data-ttu-id="79f6b-251">**多重性**</span><span class="sxs-lookup"><span data-stu-id="79f6b-251">**Multiplicity**</span></span> | <span data-ttu-id="79f6b-252">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-252">Yes</span></span>         | <span data-ttu-id="79f6b-253">**1**， **0..1**，或**\*** 可以是結尾的外部索引鍵條件約束的資料列數目而定。</span><span class="sxs-lookup"><span data-stu-id="79f6b-253">**1**, **0..1**, or **\*** depending on the number of rows that can be at the end of the foreign key constraint.</span></span> <br/> <span data-ttu-id="79f6b-254">**1**表示外部索引鍵條件約束端點上存在該只有一個資料列。</span><span class="sxs-lookup"><span data-stu-id="79f6b-254">**1** indicates that exactly one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="79f6b-255">**0..1**表示外部索引鍵條件約束端點上存在零個或一個資料列。</span><span class="sxs-lookup"><span data-stu-id="79f6b-255">**0..1** indicates that zero or one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="79f6b-256">**\*** 表示零個、 一個或多個資料列存在外部索引鍵條件約束結尾。</span><span class="sxs-lookup"><span data-stu-id="79f6b-256">**\*** indicates that zero, one, or more rows exist at the foreign key constraint end.</span></span> |
...
<span data-ttu-id="79f6b-265">**結束**項目 (為子系**AssociationSet**項目) 指定基礎資料庫中的其中一端的外部索引鍵條件約束的資料表。</span><span class="sxs-lookup"><span data-stu-id="79f6b-265">The **End** element (as a child of the **AssociationSet** element) specifies a table at one end of a foreign key constraint in the underlying database.</span></span>
...
## <a name="entitycontainer-element-ssdl"></a><span data-ttu-id="79f6b-285">EntityContainer 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-285">EntityContainer Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="79f6b-306">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-306">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-318">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-318">Applicable Attributes</span></span>
...
## <a name="entitytype-element-ssdl"></a><span data-ttu-id="79f6b-342">EntityType 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-342">EntityType Element (SSDL)</span></span>
...
<span data-ttu-id="79f6b-365">下列範例所示**EntityType**具有兩個屬性的項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-365">The following example shows an **EntityType** element with two properties:</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-378">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-378">Applicable Attributes</span></span>
...
| <span data-ttu-id="79f6b-403">**IsComposable**</span><span class="sxs-lookup"><span data-stu-id="79f6b-403">**IsComposable**</span></span>           | <span data-ttu-id="79f6b-404">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-404">No</span></span>          | <span data-ttu-id="79f6b-405">**真**如果函式是可組合<sup>3</sup>函式，**False**否則。</span><span class="sxs-lookup"><span data-stu-id="79f6b-405">**True** if the function is a composable<sup>3</sup> function; **False** otherwise.</span></span>                                                                                                                                |
...
<span data-ttu-id="79f6b-439">**OnDelete**元素可能具有下列子項目 （列出的順序）：</span><span class="sxs-lookup"><span data-stu-id="79f6b-439">An **OnDelete** element can have the following child elements (in the order listed):</span></span>
...
## <a name="parameter-element-ssdl"></a><span data-ttu-id="79f6b-457">Parameter 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-457">Parameter Element (SSDL)</span></span>
...
| <span data-ttu-id="79f6b-464">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="79f6b-464">Attribute Name</span></span> | <span data-ttu-id="79f6b-465">必要</span><span class="sxs-lookup"><span data-stu-id="79f6b-465">Is Required</span></span> | <span data-ttu-id="79f6b-466">值</span><span class="sxs-lookup"><span data-stu-id="79f6b-466">Value</span></span>                                                                                                                                                                                                                           |
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="79f6b-467">**名稱**</span><span class="sxs-lookup"><span data-stu-id="79f6b-467">**Name**</span></span>       | <span data-ttu-id="79f6b-468">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-468">Yes</span></span>         | <span data-ttu-id="79f6b-469">參數名稱。</span><span class="sxs-lookup"><span data-stu-id="79f6b-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="79f6b-470">**Type**</span><span class="sxs-lookup"><span data-stu-id="79f6b-470">**Type**</span></span>       | <span data-ttu-id="79f6b-471">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-471">Yes</span></span>         | <span data-ttu-id="79f6b-472">參數型別。</span><span class="sxs-lookup"><span data-stu-id="79f6b-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="79f6b-473">**模式**</span><span class="sxs-lookup"><span data-stu-id="79f6b-473">**Mode**</span></span>       | <span data-ttu-id="79f6b-474">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-474">No</span></span>          | <span data-ttu-id="79f6b-475">**在 **， **Out**，或**InOut**取決於參數是輸入、 輸出或輸入/輸出參數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="79f6b-476">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="79f6b-476">**MaxLength**</span></span>  | <span data-ttu-id="79f6b-477">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-477">No</span></span>          | <span data-ttu-id="79f6b-478">參數的長度上限。</span><span class="sxs-lookup"><span data-stu-id="79f6b-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="79f6b-479">**整數位數**</span><span class="sxs-lookup"><span data-stu-id="79f6b-479">**Precision**</span></span>  | <span data-ttu-id="79f6b-480">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-480">No</span></span>          | <span data-ttu-id="79f6b-481">參數的精確度。</span><span class="sxs-lookup"><span data-stu-id="79f6b-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="79f6b-482">**縮放**</span><span class="sxs-lookup"><span data-stu-id="79f6b-482">**Scale**</span></span>      | <span data-ttu-id="79f6b-483">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-483">No</span></span>          | <span data-ttu-id="79f6b-484">參數的小數位數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="79f6b-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="79f6b-485">**SRID**</span></span>       | <span data-ttu-id="79f6b-486">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-486">No</span></span>          | <span data-ttu-id="79f6b-487">系統的空間參考識別碼。</span><span class="sxs-lookup"><span data-stu-id="79f6b-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="79f6b-488">僅適用於空間類型的參數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="79f6b-489">如需詳細資訊，請參閱 [SRID](http://en.wikipedia.org/wiki/SRID)並[SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx)。</span><span class="sxs-lookup"><span data-stu-id="79f6b-489">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="79f6b-490">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**參數**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="79f6b-491">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="79f6b-492">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-493">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-493">Example</span></span>

<span data-ttu-id="79f6b-494">下列範例所示**函式**具有兩個項目**參數**指定輸入的參數的項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="79f6b-495">Principal 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="79f6b-496">**主體**存放結構定義語言 (SSDL) 中的項目是 ReferentialConstraint 項目，定義 （也稱為參考條件約束） 的外部索引鍵條件約束的主體端點的子項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="79f6b-497">**主體**元素指定另一個資料行 （或資料行） 所參考的資料表中的主索引鍵資料行 （或資料行）。</span><span class="sxs-lookup"><span data-stu-id="79f6b-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="79f6b-498">**PropertyRef**項目會指定哪些資料行參考。</span><span class="sxs-lookup"><span data-stu-id="79f6b-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="79f6b-499">相依的項目會指定參考主索引鍵資料行中所指定的資料行**主體**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="79f6b-500">**主體**元素可能具有下列子項目 （列出的順序）：</span><span class="sxs-lookup"><span data-stu-id="79f6b-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="79f6b-501">PropertyRef （一或多個）</span><span class="sxs-lookup"><span data-stu-id="79f6b-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="79f6b-502">Annotation 項目 （零或多個）</span><span class="sxs-lookup"><span data-stu-id="79f6b-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-503">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-503">Applicable Attributes</span></span>

<span data-ttu-id="79f6b-504">下表描述可套用至的屬性**主體**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="79f6b-505">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="79f6b-505">Attribute Name</span></span> | <span data-ttu-id="79f6b-506">必要</span><span class="sxs-lookup"><span data-stu-id="79f6b-506">Is Required</span></span> | <span data-ttu-id="79f6b-507">值</span><span class="sxs-lookup"><span data-stu-id="79f6b-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="79f6b-508">**角色**</span><span class="sxs-lookup"><span data-stu-id="79f6b-508">**Role**</span></span>       | <span data-ttu-id="79f6b-509">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-509">Yes</span></span>         | <span data-ttu-id="79f6b-510">相同的值**角色**屬性對應的結束項目 （如果使用）; 否則資料表的名稱，包含參考的資料行。</span><span class="sxs-lookup"><span data-stu-id="79f6b-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="79f6b-511">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**主體**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="79f6b-512">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留給 CSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="79f6b-513">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-514">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-514">Example</span></span>

<span data-ttu-id="79f6b-515">下列範例示範會使用 Association 元素**ReferentialConstraint**項目來指定參與的資料行**FK\_CustomerOrders**外部索引鍵條件約束。</span><span class="sxs-lookup"><span data-stu-id="79f6b-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="79f6b-516">**主體**項目會指定**CustomerId**資料行**客戶**做為條件約束的主體端的資料表。</span><span class="sxs-lookup"><span data-stu-id="79f6b-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="79f6b-517">Property 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-517">Property Element (SSDL)</span></span>

<span data-ttu-id="79f6b-518">**屬性**存放結構定義語言 (SSDL) 中的項目代表基礎資料庫中的資料表中的資料行。</span><span class="sxs-lookup"><span data-stu-id="79f6b-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="79f6b-519">**屬性**項目是 EntityType 項目，代表資料表中的資料列的子系。</span><span class="sxs-lookup"><span data-stu-id="79f6b-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="79f6b-520">每個**屬性**上定義的項目**EntityType**項目表示的資料行。</span><span class="sxs-lookup"><span data-stu-id="79f6b-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="79f6b-521">A**屬性**項目不能有任何子項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-522">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-522">Applicable Attributes</span></span>

<span data-ttu-id="79f6b-523">下表描述可套用至的屬性**屬性**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="79f6b-524">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="79f6b-524">Attribute Name</span></span>            | <span data-ttu-id="79f6b-525">必要</span><span class="sxs-lookup"><span data-stu-id="79f6b-525">Is Required</span></span> | <span data-ttu-id="79f6b-526">值</span><span class="sxs-lookup"><span data-stu-id="79f6b-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="79f6b-527">**名稱**</span><span class="sxs-lookup"><span data-stu-id="79f6b-527">**Name**</span></span>                  | <span data-ttu-id="79f6b-528">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-528">Yes</span></span>         | <span data-ttu-id="79f6b-529">對應資料行的名稱。</span><span class="sxs-lookup"><span data-stu-id="79f6b-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="79f6b-530">**Type**</span><span class="sxs-lookup"><span data-stu-id="79f6b-530">**Type**</span></span>                  | <span data-ttu-id="79f6b-531">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-531">Yes</span></span>         | <span data-ttu-id="79f6b-532">對應資料行的類型。</span><span class="sxs-lookup"><span data-stu-id="79f6b-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="79f6b-533">**可為 null**</span><span class="sxs-lookup"><span data-stu-id="79f6b-533">**Nullable**</span></span>              | <span data-ttu-id="79f6b-534">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-534">No</span></span>          | <span data-ttu-id="79f6b-535">**真**（預設值） 或**False**取決於對應的資料行是否可以有 null 值。</span><span class="sxs-lookup"><span data-stu-id="79f6b-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="79f6b-536">**DefaultValue**</span><span class="sxs-lookup"><span data-stu-id="79f6b-536">**DefaultValue**</span></span>          | <span data-ttu-id="79f6b-537">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-537">No</span></span>          | <span data-ttu-id="79f6b-538">對應資料行的預設值。</span><span class="sxs-lookup"><span data-stu-id="79f6b-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="79f6b-539">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="79f6b-539">**MaxLength**</span></span>             | <span data-ttu-id="79f6b-540">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-540">No</span></span>          | <span data-ttu-id="79f6b-541">對應資料行的長度上限。</span><span class="sxs-lookup"><span data-stu-id="79f6b-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="79f6b-542">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="79f6b-542">**FixedLength**</span></span>           | <span data-ttu-id="79f6b-543">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-543">No</span></span>          | <span data-ttu-id="79f6b-544">**True**或是**False**取決於對應的資料行值是否會儲存為固定的長度的字串。</span><span class="sxs-lookup"><span data-stu-id="79f6b-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="79f6b-545">**整數位數**</span><span class="sxs-lookup"><span data-stu-id="79f6b-545">**Precision**</span></span>             | <span data-ttu-id="79f6b-546">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-546">No</span></span>          | <span data-ttu-id="79f6b-547">對應資料行的精確度。</span><span class="sxs-lookup"><span data-stu-id="79f6b-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="79f6b-548">**縮放**</span><span class="sxs-lookup"><span data-stu-id="79f6b-548">**Scale**</span></span>                 | <span data-ttu-id="79f6b-549">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-549">No</span></span>          | <span data-ttu-id="79f6b-550">對應資料行的小數位數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="79f6b-551">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="79f6b-551">**Unicode**</span></span>               | <span data-ttu-id="79f6b-552">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-552">No</span></span>          | <span data-ttu-id="79f6b-553">**True**或是**False**取決於對應的資料行值是否會儲存為 Unicode 字串。</span><span class="sxs-lookup"><span data-stu-id="79f6b-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="79f6b-554">**定序**</span><span class="sxs-lookup"><span data-stu-id="79f6b-554">**Collation**</span></span>             | <span data-ttu-id="79f6b-555">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-555">No</span></span>          | <span data-ttu-id="79f6b-556">指定資料來源中使用之定序順序的字串。</span><span class="sxs-lookup"><span data-stu-id="79f6b-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="79f6b-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="79f6b-557">**SRID**</span></span>                  | <span data-ttu-id="79f6b-558">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-558">No</span></span>          | <span data-ttu-id="79f6b-559">系統的空間參考識別碼。</span><span class="sxs-lookup"><span data-stu-id="79f6b-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="79f6b-560">僅適用於空間類型的屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="79f6b-561">如需詳細資訊，請參閱 [SRID](http://en.wikipedia.org/wiki/SRID)並[SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx)。</span><span class="sxs-lookup"><span data-stu-id="79f6b-561">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="79f6b-562">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="79f6b-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="79f6b-563">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-563">No</span></span>          | <span data-ttu-id="79f6b-564">**無**，**身分識別**（如果對應的資料行值是在資料庫中產生的身分識別），或**計算**（如果對應的資料行值會計算資料庫中）。</span><span class="sxs-lookup"><span data-stu-id="79f6b-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="79f6b-565">沒有適用於資料列型別屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="79f6b-566">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**屬性**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="79f6b-567">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="79f6b-568">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-569">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-569">Example</span></span>

<span data-ttu-id="79f6b-570">下列範例所示**EntityType**具有兩個子項目**屬性**項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="79f6b-571">PropertyRef 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="79f6b-572">**PropertyRef**存放結構定義語言 (SSDL) 中的項目會參考上的 EntityType 項目，表示屬性將執行下列角色的其中一個定義的屬性：</span><span class="sxs-lookup"><span data-stu-id="79f6b-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="79f6b-573">資料表的主索引鍵的一部分， **EntityType**表示。</span><span class="sxs-lookup"><span data-stu-id="79f6b-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="79f6b-574">一或多個**PropertyRef**項目可以用來定義主索引鍵。</span><span class="sxs-lookup"><span data-stu-id="79f6b-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="79f6b-575">如需詳細資訊，請參閱索引鍵的項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="79f6b-576">做為參考條件約束的相依端點和主要端點。</span><span class="sxs-lookup"><span data-stu-id="79f6b-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="79f6b-577">如需詳細資訊，請參閱 ReferentialConstraint 項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="79f6b-578">**PropertyRef**元素只能有下列子項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="79f6b-579">（零或一個） 的文件</span><span class="sxs-lookup"><span data-stu-id="79f6b-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="79f6b-580">Annotation 項目</span><span class="sxs-lookup"><span data-stu-id="79f6b-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-581">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-581">Applicable Attributes</span></span>

<span data-ttu-id="79f6b-582">下表描述可套用至的屬性**PropertyRef**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="79f6b-583">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="79f6b-583">Attribute Name</span></span> | <span data-ttu-id="79f6b-584">必要</span><span class="sxs-lookup"><span data-stu-id="79f6b-584">Is Required</span></span> | <span data-ttu-id="79f6b-585">值</span><span class="sxs-lookup"><span data-stu-id="79f6b-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="79f6b-586">**名稱**</span><span class="sxs-lookup"><span data-stu-id="79f6b-586">**Name**</span></span>       | <span data-ttu-id="79f6b-587">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-587">Yes</span></span>         | <span data-ttu-id="79f6b-588">參考屬性的名稱。</span><span class="sxs-lookup"><span data-stu-id="79f6b-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="79f6b-589">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**PropertyRef**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="79f6b-590">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留給 CSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="79f6b-591">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-592">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-592">Example</span></span>

<span data-ttu-id="79f6b-593">下列範例所示**PropertyRef**用來定義主索引鍵所參考屬性上所定義的項目**EntityType**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="79f6b-594">ReferentialConstraint 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="79f6b-595">**ReferentialConstraint**存放結構定義語言 (SSDL) 中的項目代表基礎資料庫中的 （也稱為參考完整性條件約束） 的外部索引鍵條件約束。</span><span class="sxs-lookup"><span data-stu-id="79f6b-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="79f6b-596">會分別由主體和相依的子系項目，指定條件約束的主體和相依端點。</span><span class="sxs-lookup"><span data-stu-id="79f6b-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="79f6b-597">參與主體端和相依端資料行是使用 PropertyRef 元素參考。</span><span class="sxs-lookup"><span data-stu-id="79f6b-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="79f6b-598">**ReferentialConstraint**項目是關聯項目的選用子項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="79f6b-599">如果**ReferentialConstraint**項目不用來對應中指定的外部索引鍵條件約束**關聯**項目，AssociationSetMapping 項目必須用來執行這項操作。</span><span class="sxs-lookup"><span data-stu-id="79f6b-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="79f6b-600">**ReferentialConstraint**元素可能具有下列子元素：</span><span class="sxs-lookup"><span data-stu-id="79f6b-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="79f6b-601">（零或一個） 的文件</span><span class="sxs-lookup"><span data-stu-id="79f6b-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="79f6b-602">（只有一個） 的主體</span><span class="sxs-lookup"><span data-stu-id="79f6b-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="79f6b-603">相依 （只有一個）</span><span class="sxs-lookup"><span data-stu-id="79f6b-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="79f6b-604">Annotation 項目 （零或多個）</span><span class="sxs-lookup"><span data-stu-id="79f6b-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-605">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-605">Applicable Attributes</span></span>

<span data-ttu-id="79f6b-606">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**ReferentialConstraint**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="79f6b-607">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="79f6b-608">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-609">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-609">Example</span></span>

<span data-ttu-id="79f6b-610">下列範例所示**關聯**使用的項目**ReferentialConstraint**項目來指定參與的資料行**FK\_CustomerOrders** foreign key 條件約束：</span><span class="sxs-lookup"><span data-stu-id="79f6b-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="79f6b-611">ReturnType 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="79f6b-612">**ReturnType**存放結構定義語言 (SSDL) 中的項目會指定在定義的函式的傳回型別**函式**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="79f6b-613">傳回型別也可以使用指定的函式**ReturnType**屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="79f6b-614">使用指定的函式的傳回型別**型別**屬性或**ReturnType**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="79f6b-615">**ReturnType**元素可能具有下列子元素：</span><span class="sxs-lookup"><span data-stu-id="79f6b-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="79f6b-616">CollectionType （一）</span><span class="sxs-lookup"><span data-stu-id="79f6b-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="79f6b-617">附註屬性 （自訂 XML 屬性） 的任何數字可能會套用至**ReturnType**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="79f6b-618">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="79f6b-619">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-620">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-620">Example</span></span>

<span data-ttu-id="79f6b-621">下列範例會使用**函式**所傳回的資料列集合。</span><span class="sxs-lookup"><span data-stu-id="79f6b-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="79f6b-622">RowType 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="79f6b-623">A **RowType**存放結構定義語言 (SSDL) 中的項目會定義未命名的結構做為傳回存放中所定義的函式的型別。</span><span class="sxs-lookup"><span data-stu-id="79f6b-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="79f6b-624">A **RowType**項目是子元素**CollectionType**項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="79f6b-625">A **RowType**元素可能具有下列子元素：</span><span class="sxs-lookup"><span data-stu-id="79f6b-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="79f6b-626">屬性 （一或多個）</span><span class="sxs-lookup"><span data-stu-id="79f6b-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="79f6b-627">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-627">Example</span></span>

<span data-ttu-id="79f6b-628">下列範例示範使用的存放區函式**CollectionType**項目來指定此函數會傳回資料列集合 (如同在中指定**RowType**項目)。</span><span class="sxs-lookup"><span data-stu-id="79f6b-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="79f6b-629">Schema 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="79f6b-630">**結構描述**存放結構定義語言 (SSDL) 中的項目是儲存模型定義的根項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="79f6b-631">其中包含組成儲存模型的物件、函式和容器等定義。</span><span class="sxs-lookup"><span data-stu-id="79f6b-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="79f6b-632">**結構描述**項目可能包含零或多個下列子元素：</span><span class="sxs-lookup"><span data-stu-id="79f6b-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="79f6b-633">關聯</span><span class="sxs-lookup"><span data-stu-id="79f6b-633">Association</span></span>
-   <span data-ttu-id="79f6b-634">EntityType</span><span class="sxs-lookup"><span data-stu-id="79f6b-634">EntityType</span></span>
-   <span data-ttu-id="79f6b-635">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="79f6b-635">EntityContainer</span></span>
-   <span data-ttu-id="79f6b-636">功能</span><span class="sxs-lookup"><span data-stu-id="79f6b-636">Function</span></span>

<span data-ttu-id="79f6b-637">**結構描述**項目會使用**命名空間**屬性來定義儲存體模型中的實體類型和關聯物件的命名空間。</span><span class="sxs-lookup"><span data-stu-id="79f6b-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="79f6b-638">在命名空間中，兩個物件不能有相同的名稱。</span><span class="sxs-lookup"><span data-stu-id="79f6b-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="79f6b-639">儲存模型命名空間是 XML 命名空間的不同**結構描述**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="79f6b-640">儲存模型命名空間 (如所定義**命名空間**屬性) 是實體類型和關聯型別的邏輯容器。</span><span class="sxs-lookup"><span data-stu-id="79f6b-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="79f6b-641">XML 命名空間 (由**xmlns**屬性) 的**結構描述**項目是子元素和屬性的預設命名空間**結構描述**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="79f6b-642">XML 命名空間的表單 http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl （其中 YYYY 和 MM 表示年和月分別） 是保留供 SSDL。</span><span class="sxs-lookup"><span data-stu-id="79f6b-642">XML namespaces of the form http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="79f6b-643">自訂項目和屬性不能出現在擁有此格式的命名空間中。</span><span class="sxs-lookup"><span data-stu-id="79f6b-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="79f6b-644">適用屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-644">Applicable Attributes</span></span>

<span data-ttu-id="79f6b-645">下表描述的屬性可以套用至**結構描述**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="79f6b-646">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="79f6b-646">Attribute Name</span></span>            | <span data-ttu-id="79f6b-647">必要</span><span class="sxs-lookup"><span data-stu-id="79f6b-647">Is Required</span></span> | <span data-ttu-id="79f6b-648">值</span><span class="sxs-lookup"><span data-stu-id="79f6b-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="79f6b-649">**命名空間**</span><span class="sxs-lookup"><span data-stu-id="79f6b-649">**Namespace**</span></span>             | <span data-ttu-id="79f6b-650">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-650">Yes</span></span>         | <span data-ttu-id="79f6b-651">儲存模型的命名空間。</span><span class="sxs-lookup"><span data-stu-id="79f6b-651">The namespace of the storage model.</span></span> <span data-ttu-id="79f6b-652">值**命名空間**屬性用來構成型別的完整的名稱。</span><span class="sxs-lookup"><span data-stu-id="79f6b-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="79f6b-653">例如，如果**EntityType**名為*客戶*處於 ExampleModel.Store 命名空間中，則完整限定的名稱**EntityType**是ExampleModel.Store.Customer。</span><span class="sxs-lookup"><span data-stu-id="79f6b-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="79f6b-654">下列字串不能做為值**命名空間**屬性：**系統**，**暫時性**，或**Edm**。</span><span class="sxs-lookup"><span data-stu-id="79f6b-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="79f6b-655">值**命名空間**屬性不能做為值相同**命名空間**CSDL 結構描述項目中的屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="79f6b-656">**Alias**</span><span class="sxs-lookup"><span data-stu-id="79f6b-656">**Alias**</span></span>                 | <span data-ttu-id="79f6b-657">否</span><span class="sxs-lookup"><span data-stu-id="79f6b-657">No</span></span>          | <span data-ttu-id="79f6b-658">用來取代命名空間名稱的識別項。</span><span class="sxs-lookup"><span data-stu-id="79f6b-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="79f6b-659">例如，如果**EntityType**名為*客戶*ExampleModel.Store 命名空間和值**別名**屬性是*StorageModel*，則您可以使用 StorageModel.Customer 做為完整格式名稱**EntityType。**</span><span class="sxs-lookup"><span data-stu-id="79f6b-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="79f6b-660">**提供者**</span><span class="sxs-lookup"><span data-stu-id="79f6b-660">**Provider**</span></span>              | <span data-ttu-id="79f6b-661">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-661">Yes</span></span>         | <span data-ttu-id="79f6b-662">資料提供者。</span><span class="sxs-lookup"><span data-stu-id="79f6b-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="79f6b-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="79f6b-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="79f6b-664">是</span><span class="sxs-lookup"><span data-stu-id="79f6b-664">Yes</span></span>         | <span data-ttu-id="79f6b-665">向提供者表示要傳回哪個提供者資訊清單的語彙基元。</span><span class="sxs-lookup"><span data-stu-id="79f6b-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="79f6b-666">未定義此語彙基元的格式。</span><span class="sxs-lookup"><span data-stu-id="79f6b-666">No format for the token is defined.</span></span> <span data-ttu-id="79f6b-667">語彙基元的值是由提供者定義。</span><span class="sxs-lookup"><span data-stu-id="79f6b-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="79f6b-668">如需 SQL Server 提供者資訊清單語彙基元資訊，請參閱 Entity framework 的 SqlClient。</span><span class="sxs-lookup"><span data-stu-id="79f6b-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="79f6b-669">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-669">Example</span></span>

<span data-ttu-id="79f6b-670">下列範例所示**結構描述**包含的項目**EntityContainer**元素中，兩個**EntityType**項目和一個**關聯**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="79f6b-671">註釋屬性</span><span class="sxs-lookup"><span data-stu-id="79f6b-671">Annotation Attributes</span></span>

<span data-ttu-id="79f6b-672">存放結構定義語言 (SSDL) 中的 Annotation 屬性是儲存體模型中的自訂 XML 屬性，它們可提供與儲存體模型中之項目相關的額外中繼資料。</span><span class="sxs-lookup"><span data-stu-id="79f6b-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="79f6b-673">除了擁有有效的 XML 結構外，下列條件約束適用於 Annotation 屬性：</span><span class="sxs-lookup"><span data-stu-id="79f6b-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="79f6b-674">Annotation 屬性不能在任何 XML 命名空間之中，這是保留供 SSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="79f6b-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="79f6b-675">任兩個 Annotation 屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="79f6b-676">可以將一個以上的 Annotation 屬性套用至指定的 SSDL 項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="79f6b-677">可以使用 System.Data.Metadata.Edm 命名空間中的類別，在執行階段存取 annotation 項目中包含的中繼資料。</span><span class="sxs-lookup"><span data-stu-id="79f6b-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-678">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-678">Example</span></span>

<span data-ttu-id="79f6b-679">下列範例示範具有 annotation 屬性套用至的 EntityType 項目**OrderId**屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="79f6b-680">該範例也顯示註釋項目加入至**EntityType**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="79f6b-681">Annotation 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="79f6b-682">存放結構定義語言 (SSDL) 中的 Annotation 項目是儲存體模型中的自訂 XML 項目，它們可提供與儲存體模型相關的額外中繼資料。</span><span class="sxs-lookup"><span data-stu-id="79f6b-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="79f6b-683">除了擁有有效的 XML 結構外，下列條件約束適用於 Annotation 項目：</span><span class="sxs-lookup"><span data-stu-id="79f6b-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="79f6b-684">Annotation 項目不能存在於保留供 SSDL 使用的任何 XML 命名空間中。</span><span class="sxs-lookup"><span data-stu-id="79f6b-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="79f6b-685">任兩個 Annotation 項目的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="79f6b-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="79f6b-686">Annotation 項目必須出現在所指定 SSDL 項目的所有其他子項目之後。</span><span class="sxs-lookup"><span data-stu-id="79f6b-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="79f6b-687">多個 Annotation 項目可以同時做為所指定 SSDL 項目的子系。</span><span class="sxs-lookup"><span data-stu-id="79f6b-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="79f6b-688">從.NET Framework 第 4 版開始，中繼資料包含在 annotation 項目可以存取在執行階段使用 System.Data.Metadata.Edm 命名空間中類別。</span><span class="sxs-lookup"><span data-stu-id="79f6b-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="79f6b-689">範例</span><span class="sxs-lookup"><span data-stu-id="79f6b-689">Example</span></span>

<span data-ttu-id="79f6b-690">下列範例示範具有 annotation 項目的 EntityType 項目 (**CustomElement**)。</span><span class="sxs-lookup"><span data-stu-id="79f6b-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="79f6b-691">此範例也會示範套用至的註釋屬性**OrderId**屬性。</span><span class="sxs-lookup"><span data-stu-id="79f6b-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="79f6b-692">Facet (SSDL)</span><span class="sxs-lookup"><span data-stu-id="79f6b-692">Facets (SSDL)</span></span>

<span data-ttu-id="79f6b-693">存放結構定義語言 (SSDL) 中的 facet 表示屬性項目中指定的資料行型別條件約束。</span><span class="sxs-lookup"><span data-stu-id="79f6b-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="79f6b-694">Facet 會實作為 XML 屬性上**屬性**項目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="79f6b-695">下表說明 SSDL 中支援的 Facet：</span><span class="sxs-lookup"><span data-stu-id="79f6b-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="79f6b-696">Facet</span><span class="sxs-lookup"><span data-stu-id="79f6b-696">Facet</span></span>           | <span data-ttu-id="79f6b-697">描述</span><span class="sxs-lookup"><span data-stu-id="79f6b-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="79f6b-698">**定序**</span><span class="sxs-lookup"><span data-stu-id="79f6b-698">**Collation**</span></span>   | <span data-ttu-id="79f6b-699">在執行比較和排序屬性值的作業時，指定要使用的定序順序 (或排序順序)。</span><span class="sxs-lookup"><span data-stu-id="79f6b-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="79f6b-700">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="79f6b-700">**FixedLength**</span></span> | <span data-ttu-id="79f6b-701">指定資料行值的長度是否可以變更。</span><span class="sxs-lookup"><span data-stu-id="79f6b-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="79f6b-702">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="79f6b-702">**MaxLength**</span></span>   | <span data-ttu-id="79f6b-703">指定資料行值的最大長度。</span><span class="sxs-lookup"><span data-stu-id="79f6b-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="79f6b-704">**整數位數**</span><span class="sxs-lookup"><span data-stu-id="79f6b-704">**Precision**</span></span>   | <span data-ttu-id="79f6b-705">屬性的型別**十進位**，指定屬性值的數字數目。</span><span class="sxs-lookup"><span data-stu-id="79f6b-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="79f6b-706">屬性的型別**時間**， **DateTime**，並**DateTimeOffset**，指定資料行值秒數的小數部分的位數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="79f6b-707">**縮放**</span><span class="sxs-lookup"><span data-stu-id="79f6b-707">**Scale**</span></span>       | <span data-ttu-id="79f6b-708">指定資料行值小數點右邊的位數。</span><span class="sxs-lookup"><span data-stu-id="79f6b-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="79f6b-709">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="79f6b-709">**Unicode**</span></span>     | <span data-ttu-id="79f6b-710">指定資料行值是否儲存為 Unicode。</span><span class="sxs-lookup"><span data-stu-id="79f6b-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
