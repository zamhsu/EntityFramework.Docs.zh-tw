...
### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-148">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-148">Applicable Attributes</span></span>
...
<span data-ttu-id="5f10d-178">**CommandText**元素沒有適用的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-178">No attributes are applicable to the **CommandText** element.</span></span>
...
<span data-ttu-id="5f10d-188">您可以使用 Entity Framework 中的預存程式，透過 views 啟用讀寫案例。</span><span class="sxs-lookup"><span data-stu-id="5f10d-188">You can use stored procedures in the Entity Framework to enable read-write scenarios over views.</span></span><span data-ttu-id="5f10d-189"> 您可以使用資料來源 view 或 Entity SQL view，做為用來抓取資料的基表和預存程式的變更處理。</span><span class="sxs-lookup"><span data-stu-id="5f10d-189"> You can use either a data source view or an Entity SQL view as the base table for retrieving data and for change processing by stored procedures.</span></span>
...
<span data-ttu-id="5f10d-203">下表描述可套用至**相依**元素的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-203">The following table describes the attributes that can be applied to the **Dependent** element.</span></span>
...
<span data-ttu-id="5f10d-217">存放結構定義語言（SSDL）中的**檔**專案可以用來提供父元素中所定義之物件的相關資訊。</span><span class="sxs-lookup"><span data-stu-id="5f10d-217">The **Documentation** element in store schema definition language (SSDL) can be used to provide information about an object that is defined in a parent element.</span></span>
...
| <span data-ttu-id="5f10d-251">**多重性**</span><span class="sxs-lookup"><span data-stu-id="5f10d-251">**Multiplicity**</span></span> | <span data-ttu-id="5f10d-252">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-252">Yes</span></span>         | <span data-ttu-id="5f10d-253">**1**、 **0、1**或 **\*** 取決於外鍵條件約束結尾的資料列數目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-253">**1**, **0..1**, or **\*** depending on the number of rows that can be at the end of the foreign key constraint.</span></span> <br/> <span data-ttu-id="5f10d-254">**1**表示外鍵條件約束結尾只存在一個資料列。</span><span class="sxs-lookup"><span data-stu-id="5f10d-254">**1** indicates that exactly one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="5f10d-255">**0 ..1**表示外鍵條件約束結尾處有零或一個資料列。</span><span class="sxs-lookup"><span data-stu-id="5f10d-255">**0..1** indicates that zero or one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="5f10d-256">**\*** 指出外鍵條件約束結尾處有零個、一個或多個資料列。</span><span class="sxs-lookup"><span data-stu-id="5f10d-256">**\*** indicates that zero, one, or more rows exist at the foreign key constraint end.</span></span> |
...
<span data-ttu-id="5f10d-265">**End**專案（做為**AssociationSet**專案的子專案）會指定基礎資料庫中外鍵條件約束一端的資料表。</span><span class="sxs-lookup"><span data-stu-id="5f10d-265">The **End** element (as a child of the **AssociationSet** element) specifies a table at one end of a foreign key constraint in the underlying database.</span></span>
...
## <a name="entitycontainer-element-ssdl"></a><span data-ttu-id="5f10d-285">EntityContainer 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-285">EntityContainer Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="5f10d-306">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-306">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-318">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-318">Applicable Attributes</span></span>
...
## <a name="entitytype-element-ssdl"></a><span data-ttu-id="5f10d-342">EntityType 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-342">EntityType Element (SSDL)</span></span>
...
<span data-ttu-id="5f10d-365">下列範例顯示具有兩個屬性的**EntityType**元素：</span><span class="sxs-lookup"><span data-stu-id="5f10d-365">The following example shows an **EntityType** element with two properties:</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-378">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-378">Applicable Attributes</span></span>
...
| <span data-ttu-id="5f10d-403">**IsComposable**</span><span class="sxs-lookup"><span data-stu-id="5f10d-403">**IsComposable**</span></span>           | <span data-ttu-id="5f10d-404">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-404">No</span></span>          | <span data-ttu-id="5f10d-405">如果函式是可組合的<sup>3</sup>個函數，則為**True** ;否則**為 False** 。</span><span class="sxs-lookup"><span data-stu-id="5f10d-405">**True** if the function is a composable<sup>3</sup> function; **False** otherwise.</span></span>                                                                                                                                |
...
<span data-ttu-id="5f10d-439">**OnDelete**元素可以有下列子專案（依列出的順序）：</span><span class="sxs-lookup"><span data-stu-id="5f10d-439">An **OnDelete** element can have the following child elements (in the order listed):</span></span>
...
## <a name="parameter-element-ssdl"></a><span data-ttu-id="5f10d-457">Parameter 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-457">Parameter Element (SSDL)</span></span>
...
| <span data-ttu-id="5f10d-464">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="5f10d-464">Attribute Name</span></span> | <span data-ttu-id="5f10d-465">必要</span><span class="sxs-lookup"><span data-stu-id="5f10d-465">Is Required</span></span> | <span data-ttu-id="5f10d-466">值</span><span class="sxs-lookup"><span data-stu-id="5f10d-466">Value</span></span>                                                                                                                                                                                                                           |
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f10d-467">**名稱**</span><span class="sxs-lookup"><span data-stu-id="5f10d-467">**Name**</span></span>       | <span data-ttu-id="5f10d-468">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-468">Yes</span></span>         | <span data-ttu-id="5f10d-469">參數名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="5f10d-470">**型別**</span><span class="sxs-lookup"><span data-stu-id="5f10d-470">**Type**</span></span>       | <span data-ttu-id="5f10d-471">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-471">Yes</span></span>         | <span data-ttu-id="5f10d-472">參數類型。</span><span class="sxs-lookup"><span data-stu-id="5f10d-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="5f10d-473">**模式**</span><span class="sxs-lookup"><span data-stu-id="5f10d-473">**Mode**</span></span>       | <span data-ttu-id="5f10d-474">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-474">No</span></span>          | <span data-ttu-id="5f10d-475">**In**、 **Out**或**InOut** ，取決於參數是輸入、輸出或輸入/輸出參數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="5f10d-476">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="5f10d-476">**MaxLength**</span></span>  | <span data-ttu-id="5f10d-477">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-477">No</span></span>          | <span data-ttu-id="5f10d-478">參數的長度上限。</span><span class="sxs-lookup"><span data-stu-id="5f10d-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="5f10d-479">**有效位數**</span><span class="sxs-lookup"><span data-stu-id="5f10d-479">**Precision**</span></span>  | <span data-ttu-id="5f10d-480">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-480">No</span></span>          | <span data-ttu-id="5f10d-481">參數的精確度。</span><span class="sxs-lookup"><span data-stu-id="5f10d-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="5f10d-482">**調整**</span><span class="sxs-lookup"><span data-stu-id="5f10d-482">**Scale**</span></span>      | <span data-ttu-id="5f10d-483">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-483">No</span></span>          | <span data-ttu-id="5f10d-484">參數的小數位數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="5f10d-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="5f10d-485">**SRID**</span></span>       | <span data-ttu-id="5f10d-486">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-486">No</span></span>          | <span data-ttu-id="5f10d-487">空間系統參考識別碼。</span><span class="sxs-lookup"><span data-stu-id="5f10d-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="5f10d-488">僅對空間類型的參數有效。</span><span class="sxs-lookup"><span data-stu-id="5f10d-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="5f10d-489">如需詳細資訊，請參閱[SRID](https://en.wikipedia.org/wiki/SRID) and [SRID （SQL Server）](https://msdn.microsoft.com/library/bb964707.aspx)。</span><span class="sxs-lookup"><span data-stu-id="5f10d-489">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="5f10d-490">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**Parameter**元素。</span><span class="sxs-lookup"><span data-stu-id="5f10d-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="5f10d-491">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="5f10d-492">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-493">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-493">Example</span></span>

<span data-ttu-id="5f10d-494">下列範例**顯示的函式元素具有**兩個指定輸入參數的**參數**元素：</span><span class="sxs-lookup"><span data-stu-id="5f10d-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="5f10d-495">Principal 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="5f10d-496">存放結構定義語言（SSDL）中的**Principal**元素是 ReferentialConstraint 元素的子專案，可定義外鍵條件約束（也稱為參考條件約束）的主要端點。</span><span class="sxs-lookup"><span data-stu-id="5f10d-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="5f10d-497">**Principal**元素會在另一個資料行（或資料行）所參考的資料表中，指定主鍵資料行（或資料行）。</span><span class="sxs-lookup"><span data-stu-id="5f10d-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="5f10d-498">**PropertyRef**元素會指定要參考的資料行。</span><span class="sxs-lookup"><span data-stu-id="5f10d-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="5f10d-499">Dependent 元素會指定參考**Principal**元素中所指定之主鍵資料行的資料行。</span><span class="sxs-lookup"><span data-stu-id="5f10d-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="5f10d-500">**Principal**元素可以具有下列子專案（依列出的順序）：</span><span class="sxs-lookup"><span data-stu-id="5f10d-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="5f10d-501">PropertyRef (一個或多個)</span><span class="sxs-lookup"><span data-stu-id="5f10d-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="5f10d-502">註釋項目 (零或多個)</span><span class="sxs-lookup"><span data-stu-id="5f10d-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-503">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-503">Applicable Attributes</span></span>

<span data-ttu-id="5f10d-504">下表描述可套用至**主體**元素的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="5f10d-505">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="5f10d-505">Attribute Name</span></span> | <span data-ttu-id="5f10d-506">必要</span><span class="sxs-lookup"><span data-stu-id="5f10d-506">Is Required</span></span> | <span data-ttu-id="5f10d-507">值</span><span class="sxs-lookup"><span data-stu-id="5f10d-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f10d-508">**角色**</span><span class="sxs-lookup"><span data-stu-id="5f10d-508">**Role**</span></span>       | <span data-ttu-id="5f10d-509">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-509">Yes</span></span>         | <span data-ttu-id="5f10d-510">與對應之 End 專案的**Role**屬性（如果使用的話）相同的值。否則，就是包含參考資料行之資料表的名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="5f10d-511">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**主體**元素。</span><span class="sxs-lookup"><span data-stu-id="5f10d-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="5f10d-512">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留給 CSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="5f10d-513">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-514">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-514">Example</span></span>

<span data-ttu-id="5f10d-515">下列範例顯示的 Association 專案，會使用**ReferentialConstraint**元素來指定參與**FK\_CustomerOrders** foreign key 條件約束的資料行。</span><span class="sxs-lookup"><span data-stu-id="5f10d-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="5f10d-516">**Principal**元素會將**Customer**資料表的**CustomerId**資料行指定為條件約束的主要端點。</span><span class="sxs-lookup"><span data-stu-id="5f10d-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="5f10d-517">Property 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-517">Property Element (SSDL)</span></span>

<span data-ttu-id="5f10d-518">存放結構定義語言（SSDL）中的**屬性**專案代表基礎資料庫中資料表的資料行。</span><span class="sxs-lookup"><span data-stu-id="5f10d-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="5f10d-519">**屬性**元素是 EntityType 元素的子系，代表資料表中的資料列。</span><span class="sxs-lookup"><span data-stu-id="5f10d-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="5f10d-520">**EntityType**元素上定義的每個**屬性**專案都代表一個資料行。</span><span class="sxs-lookup"><span data-stu-id="5f10d-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="5f10d-521">**Property**元素不能有任何子專案。</span><span class="sxs-lookup"><span data-stu-id="5f10d-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-522">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-522">Applicable Attributes</span></span>

<span data-ttu-id="5f10d-523">下表描述可套用至**Property**元素的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="5f10d-524">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="5f10d-524">Attribute Name</span></span>            | <span data-ttu-id="5f10d-525">必要</span><span class="sxs-lookup"><span data-stu-id="5f10d-525">Is Required</span></span> | <span data-ttu-id="5f10d-526">值</span><span class="sxs-lookup"><span data-stu-id="5f10d-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f10d-527">**名稱**</span><span class="sxs-lookup"><span data-stu-id="5f10d-527">**Name**</span></span>                  | <span data-ttu-id="5f10d-528">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-528">Yes</span></span>         | <span data-ttu-id="5f10d-529">對應資料行的名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="5f10d-530">**型別**</span><span class="sxs-lookup"><span data-stu-id="5f10d-530">**Type**</span></span>                  | <span data-ttu-id="5f10d-531">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-531">Yes</span></span>         | <span data-ttu-id="5f10d-532">對應資料行的類型。</span><span class="sxs-lookup"><span data-stu-id="5f10d-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="5f10d-533">**可為 Null**</span><span class="sxs-lookup"><span data-stu-id="5f10d-533">**Nullable**</span></span>              | <span data-ttu-id="5f10d-534">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-534">No</span></span>          | <span data-ttu-id="5f10d-535">**True** （預設值）或**False** ，取決於對應的資料行是否可以有 null 值。</span><span class="sxs-lookup"><span data-stu-id="5f10d-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="5f10d-536">**DefaultValue**</span><span class="sxs-lookup"><span data-stu-id="5f10d-536">**DefaultValue**</span></span>          | <span data-ttu-id="5f10d-537">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-537">No</span></span>          | <span data-ttu-id="5f10d-538">對應資料行的預設值。</span><span class="sxs-lookup"><span data-stu-id="5f10d-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="5f10d-539">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="5f10d-539">**MaxLength**</span></span>             | <span data-ttu-id="5f10d-540">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-540">No</span></span>          | <span data-ttu-id="5f10d-541">對應資料行的長度上限。</span><span class="sxs-lookup"><span data-stu-id="5f10d-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="5f10d-542">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="5f10d-542">**FixedLength**</span></span>           | <span data-ttu-id="5f10d-543">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-543">No</span></span>          | <span data-ttu-id="5f10d-544">**True**或**False** ，取決於對應的資料行值是否會儲存為固定長度的字串。</span><span class="sxs-lookup"><span data-stu-id="5f10d-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="5f10d-545">**有效位數**</span><span class="sxs-lookup"><span data-stu-id="5f10d-545">**Precision**</span></span>             | <span data-ttu-id="5f10d-546">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-546">No</span></span>          | <span data-ttu-id="5f10d-547">對應資料行的精確度。</span><span class="sxs-lookup"><span data-stu-id="5f10d-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="5f10d-548">**調整**</span><span class="sxs-lookup"><span data-stu-id="5f10d-548">**Scale**</span></span>                 | <span data-ttu-id="5f10d-549">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-549">No</span></span>          | <span data-ttu-id="5f10d-550">對應資料行的小數位數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="5f10d-551">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="5f10d-551">**Unicode**</span></span>               | <span data-ttu-id="5f10d-552">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-552">No</span></span>          | <span data-ttu-id="5f10d-553">**True**或**False** ，取決於對應的資料行值是否會儲存為 Unicode 字串。</span><span class="sxs-lookup"><span data-stu-id="5f10d-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="5f10d-554">**定序**</span><span class="sxs-lookup"><span data-stu-id="5f10d-554">**Collation**</span></span>             | <span data-ttu-id="5f10d-555">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-555">No</span></span>          | <span data-ttu-id="5f10d-556">指定要在資料來源使用之定序的字串。</span><span class="sxs-lookup"><span data-stu-id="5f10d-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="5f10d-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="5f10d-557">**SRID**</span></span>                  | <span data-ttu-id="5f10d-558">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-558">No</span></span>          | <span data-ttu-id="5f10d-559">空間系統參考識別碼。</span><span class="sxs-lookup"><span data-stu-id="5f10d-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="5f10d-560">僅對空間類型的屬性有效。</span><span class="sxs-lookup"><span data-stu-id="5f10d-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="5f10d-561">如需詳細資訊，請參閱[SRID](https://en.wikipedia.org/wiki/SRID) and [SRID （SQL Server）](https://msdn.microsoft.com/library/bb964707.aspx)。</span><span class="sxs-lookup"><span data-stu-id="5f10d-561">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="5f10d-562">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="5f10d-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="5f10d-563">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-563">No</span></span>          | <span data-ttu-id="5f10d-564">**無**、**識別**（如果對應的資料行值是在資料庫中產生的身分識別），或**計算**（如果對應的資料行值是在資料庫中計算）。</span><span class="sxs-lookup"><span data-stu-id="5f10d-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="5f10d-565">對 RowType 屬性無效。</span><span class="sxs-lookup"><span data-stu-id="5f10d-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="5f10d-566">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**屬性**專案。</span><span class="sxs-lookup"><span data-stu-id="5f10d-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="5f10d-567">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="5f10d-568">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-569">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-569">Example</span></span>

<span data-ttu-id="5f10d-570">下列範例顯示具有兩個子**屬性**元素的**EntityType**元素：</span><span class="sxs-lookup"><span data-stu-id="5f10d-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="5f10d-571">PropertyRef 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="5f10d-572">存放結構定義語言（SSDL）中的**PropertyRef**元素會參考 EntityType 元素上定義的屬性，以指出屬性將會執行下列其中一個角色：</span><span class="sxs-lookup"><span data-stu-id="5f10d-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="5f10d-573">屬於**EntityType**所代表之資料表的主鍵。</span><span class="sxs-lookup"><span data-stu-id="5f10d-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="5f10d-574">一或多個**PropertyRef**元素可以用來定義主鍵。</span><span class="sxs-lookup"><span data-stu-id="5f10d-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="5f10d-575">如需詳細資訊，請參閱 Key 項目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="5f10d-576">做為參考條件約束的相依端點和主要端點。</span><span class="sxs-lookup"><span data-stu-id="5f10d-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="5f10d-577">如需詳細資訊，請參閱 ReferentialConstraint 項目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="5f10d-578">**PropertyRef**元素只能有下列子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="5f10d-579">檔（零或一個）</span><span class="sxs-lookup"><span data-stu-id="5f10d-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="5f10d-580">Annotation 元素</span><span class="sxs-lookup"><span data-stu-id="5f10d-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-581">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-581">Applicable Attributes</span></span>

<span data-ttu-id="5f10d-582">下表描述可套用至**PropertyRef**元素的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="5f10d-583">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="5f10d-583">Attribute Name</span></span> | <span data-ttu-id="5f10d-584">必要</span><span class="sxs-lookup"><span data-stu-id="5f10d-584">Is Required</span></span> | <span data-ttu-id="5f10d-585">值</span><span class="sxs-lookup"><span data-stu-id="5f10d-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="5f10d-586">**名稱**</span><span class="sxs-lookup"><span data-stu-id="5f10d-586">**Name**</span></span>       | <span data-ttu-id="5f10d-587">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-587">Yes</span></span>         | <span data-ttu-id="5f10d-588">參考屬性的名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="5f10d-589">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**PropertyRef**元素。</span><span class="sxs-lookup"><span data-stu-id="5f10d-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="5f10d-590">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留給 CSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="5f10d-591">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-592">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-592">Example</span></span>

<span data-ttu-id="5f10d-593">下列範例顯示的**PropertyRef**專案，是用來藉由參考**EntityType**元素上定義的屬性來定義主鍵。</span><span class="sxs-lookup"><span data-stu-id="5f10d-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="5f10d-594">ReferentialConstraint 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="5f10d-595">存放結構定義語言（SSDL）中的**ReferentialConstraint**元素代表基礎資料庫中的外鍵條件約束（也稱為參考完整性條件約束）。</span><span class="sxs-lookup"><span data-stu-id="5f10d-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="5f10d-596">條件約束的主體端和相依端是分別透過 Principal 和 Dependent 子項目指定的。</span><span class="sxs-lookup"><span data-stu-id="5f10d-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="5f10d-597">參與主體端和相依端之資料行是以 PropertyRef 項目來參考的。</span><span class="sxs-lookup"><span data-stu-id="5f10d-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="5f10d-598">**ReferentialConstraint**元素是 Association 元素的選擇性子項目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="5f10d-599">如果**ReferentialConstraint**元素不是用來對應**Association**元素中所指定的 foreign key 條件約束，就必須使用 AssociationSetMapping 專案來執行此動作。</span><span class="sxs-lookup"><span data-stu-id="5f10d-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="5f10d-600">**ReferentialConstraint**元素可以有下列子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="5f10d-601">檔（零或一個）</span><span class="sxs-lookup"><span data-stu-id="5f10d-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="5f10d-602">Principal (只有一個)</span><span class="sxs-lookup"><span data-stu-id="5f10d-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="5f10d-603">相依（只有一個）</span><span class="sxs-lookup"><span data-stu-id="5f10d-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="5f10d-604">註釋項目 (零或多個)</span><span class="sxs-lookup"><span data-stu-id="5f10d-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-605">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-605">Applicable Attributes</span></span>

<span data-ttu-id="5f10d-606">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**ReferentialConstraint**元素。</span><span class="sxs-lookup"><span data-stu-id="5f10d-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="5f10d-607">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="5f10d-608">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-609">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-609">Example</span></span>

<span data-ttu-id="5f10d-610">下列範例顯示的**Association**元素，會使用**ReferentialConstraint**元素來指定參與**FK\_CustomerOrders** foreign key 條件約束的資料行：</span><span class="sxs-lookup"><span data-stu-id="5f10d-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="5f10d-611">ReturnType 元素（SSDL）</span><span class="sxs-lookup"><span data-stu-id="5f10d-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="5f10d-612">存放結構定義語言（SSDL）中的**ReturnType**元素會指定在**function**元素中定義之函式的傳回類型。</span><span class="sxs-lookup"><span data-stu-id="5f10d-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="5f10d-613">函式傳回型別也可以使用**ReturnType**屬性來指定。</span><span class="sxs-lookup"><span data-stu-id="5f10d-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="5f10d-614">函式的傳回型別是使用**type**屬性或**ReturnType**元素所指定。</span><span class="sxs-lookup"><span data-stu-id="5f10d-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="5f10d-615">**ReturnType**元素可以具有下列子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="5f10d-616">CollectionType （一）</span><span class="sxs-lookup"><span data-stu-id="5f10d-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="5f10d-617">任何數目的注釋屬性（自訂 XML 屬性）都可以套用至**ReturnType**元素。</span><span class="sxs-lookup"><span data-stu-id="5f10d-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="5f10d-618">不過，自訂屬性不可屬於任何 XML 命名空間，這是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="5f10d-619">任兩個自訂屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-620">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-620">Example</span></span>

<span data-ttu-id="5f10d-621">下列範例會使用傳回資料列集合的**函數**。</span><span class="sxs-lookup"><span data-stu-id="5f10d-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="5f10d-622">RowType 元素（SSDL）</span><span class="sxs-lookup"><span data-stu-id="5f10d-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="5f10d-623">存放結構定義語言（SSDL）中的**RowType**專案會將未命名的結構定義為存放區中定義之函式的傳回型別。</span><span class="sxs-lookup"><span data-stu-id="5f10d-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="5f10d-624">**RowType**元素是**CollectionType**元素的子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="5f10d-625">**RowType**元素可以有下列子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="5f10d-626">屬性 (一個或多個)</span><span class="sxs-lookup"><span data-stu-id="5f10d-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="5f10d-627">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-627">Example</span></span>

<span data-ttu-id="5f10d-628">下列範例顯示使用**CollectionType**元素的存放區函式，以指定函式傳回資料列集合（如**RowType**元素中所指定）。</span><span class="sxs-lookup"><span data-stu-id="5f10d-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="5f10d-629">Schema 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="5f10d-630">存放結構定義語言（SSDL）中的**架構**元素是儲存模型定義的根項目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="5f10d-631">其中包含組成儲存模型的物件、函式和容器等定義。</span><span class="sxs-lookup"><span data-stu-id="5f10d-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="5f10d-632">**Schema**元素可以包含零個或多個下列子項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="5f10d-633">關聯</span><span class="sxs-lookup"><span data-stu-id="5f10d-633">Association</span></span>
-   <span data-ttu-id="5f10d-634">EntityType</span><span class="sxs-lookup"><span data-stu-id="5f10d-634">EntityType</span></span>
-   <span data-ttu-id="5f10d-635">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="5f10d-635">EntityContainer</span></span>
-   <span data-ttu-id="5f10d-636">函式</span><span class="sxs-lookup"><span data-stu-id="5f10d-636">Function</span></span>

<span data-ttu-id="5f10d-637">**Schema**元素會使用**namespace**屬性來定義儲存模型中實體類型和關聯物件的命名空間。</span><span class="sxs-lookup"><span data-stu-id="5f10d-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="5f10d-638">在命名空間中，兩個物件不能有相同的名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="5f10d-639">儲存模型命名空間與**架構**元素的 XML 命名空間不同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="5f10d-640">儲存模型命名空間（如**命名空間**屬性所定義）是實體類型和關聯類型的邏輯容器。</span><span class="sxs-lookup"><span data-stu-id="5f10d-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="5f10d-641">**Schema**元素的 XML 命名空間（由**xmlns**屬性所表示）是**schema**專案之子專案和屬性的預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="5f10d-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="5f10d-642">https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl 格式的 XML 命名空間（其中 YYYY 和 MM 分別表示年和月）是保留供 SSDL 使用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-642">XML namespaces of the form https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="5f10d-643">自訂項目和屬性不能出現在擁有此格式的命名空間中。</span><span class="sxs-lookup"><span data-stu-id="5f10d-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="5f10d-644">適用的屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-644">Applicable Attributes</span></span>

<span data-ttu-id="5f10d-645">下表描述可套用至**架構**元素的屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="5f10d-646">屬性名稱</span><span class="sxs-lookup"><span data-stu-id="5f10d-646">Attribute Name</span></span>            | <span data-ttu-id="5f10d-647">必要</span><span class="sxs-lookup"><span data-stu-id="5f10d-647">Is Required</span></span> | <span data-ttu-id="5f10d-648">值</span><span class="sxs-lookup"><span data-stu-id="5f10d-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f10d-649">**Namespace**</span><span class="sxs-lookup"><span data-stu-id="5f10d-649">**Namespace**</span></span>             | <span data-ttu-id="5f10d-650">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-650">Yes</span></span>         | <span data-ttu-id="5f10d-651">儲存模型的命名空間。</span><span class="sxs-lookup"><span data-stu-id="5f10d-651">The namespace of the storage model.</span></span> <span data-ttu-id="5f10d-652">**Namespace**屬性的值是用來形成類型的完整名稱。</span><span class="sxs-lookup"><span data-stu-id="5f10d-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="5f10d-653">例如，如果名為*Customer*的**EntityType**是在 examplemodel.store.customer 命名空間中，則**entitytype**的完整限定名稱為 examplemodel.store.customer。</span><span class="sxs-lookup"><span data-stu-id="5f10d-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="5f10d-654">下列字串不能當做**Namespace**屬性的值使用： **System**、**暫時性**或**Edm**。</span><span class="sxs-lookup"><span data-stu-id="5f10d-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="5f10d-655">**Namespace**屬性的值不能與 CSDL Schema 元素中**namespace**屬性的值相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="5f10d-656">**別名**</span><span class="sxs-lookup"><span data-stu-id="5f10d-656">**Alias**</span></span>                 | <span data-ttu-id="5f10d-657">否</span><span class="sxs-lookup"><span data-stu-id="5f10d-657">No</span></span>          | <span data-ttu-id="5f10d-658">用來取代命名空間名稱的識別項。</span><span class="sxs-lookup"><span data-stu-id="5f10d-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="5f10d-659">例如，如果名為*Customer*的**EntityType**是在 Examplemodel.store.customer 中，而且**Alias**屬性的值是*StorageModel*，則您可以使用 StorageModel 做為 EntityType 的完整名稱 **。**</span><span class="sxs-lookup"><span data-stu-id="5f10d-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="5f10d-660">**提供者**</span><span class="sxs-lookup"><span data-stu-id="5f10d-660">**Provider**</span></span>              | <span data-ttu-id="5f10d-661">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-661">Yes</span></span>         | <span data-ttu-id="5f10d-662">資料提供者。</span><span class="sxs-lookup"><span data-stu-id="5f10d-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="5f10d-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="5f10d-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="5f10d-664">是</span><span class="sxs-lookup"><span data-stu-id="5f10d-664">Yes</span></span>         | <span data-ttu-id="5f10d-665">向提供者表示要傳回哪個提供者資訊清單的語彙基元。</span><span class="sxs-lookup"><span data-stu-id="5f10d-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="5f10d-666">未定義此語彙基元的格式。</span><span class="sxs-lookup"><span data-stu-id="5f10d-666">No format for the token is defined.</span></span> <span data-ttu-id="5f10d-667">語彙基元的值是由提供者定義。</span><span class="sxs-lookup"><span data-stu-id="5f10d-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="5f10d-668">如需有關 SQL Server 提供者資訊清單標記的詳細資訊，請參閱 SqlClient for Entity Framework。</span><span class="sxs-lookup"><span data-stu-id="5f10d-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="5f10d-669">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-669">Example</span></span>

<span data-ttu-id="5f10d-670">下列範例顯示包含**EntityContainer**元素、兩個**EntityType**專案和一個**Association**元素的**Schema**專案。</span><span class="sxs-lookup"><span data-stu-id="5f10d-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="5f10d-671">註釋屬性</span><span class="sxs-lookup"><span data-stu-id="5f10d-671">Annotation Attributes</span></span>

<span data-ttu-id="5f10d-672">存放結構定義語言 (SSDL) 中的 Annotation 屬性是儲存體模型中的自訂 XML 屬性，它們可提供與儲存體模型中之項目相關的額外中繼資料。</span><span class="sxs-lookup"><span data-stu-id="5f10d-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="5f10d-673">除了擁有有效的 XML 結構外，下列條件約束適用於 Annotation 屬性：</span><span class="sxs-lookup"><span data-stu-id="5f10d-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="5f10d-674">Annotation 屬性不能在任何 XML 命名空間之中，這是保留供 SSDL 之用。</span><span class="sxs-lookup"><span data-stu-id="5f10d-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="5f10d-675">任兩個 Annotation 屬性的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="5f10d-676">可以將一個以上的 Annotation 屬性套用至指定的 SSDL 項目。</span><span class="sxs-lookup"><span data-stu-id="5f10d-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="5f10d-677">注釋專案中包含的中繼資料可在執行時間使用 system.string. 中繼資料命名空間中的類別來存取。</span><span class="sxs-lookup"><span data-stu-id="5f10d-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-678">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-678">Example</span></span>

<span data-ttu-id="5f10d-679">下列範例顯示的 EntityType 專案，具有套用至 [**訂單**] 屬性的 annotation 屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="5f10d-680">此範例也會顯示加入至**EntityType**元素的 annotation 專案。</span><span class="sxs-lookup"><span data-stu-id="5f10d-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="5f10d-681">Annotation 項目 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="5f10d-682">存放結構定義語言 (SSDL) 中的 Annotation 項目是儲存體模型中的自訂 XML 項目，它們可提供與儲存體模型相關的額外中繼資料。</span><span class="sxs-lookup"><span data-stu-id="5f10d-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="5f10d-683">除了擁有有效的 XML 結構外，下列條件約束適用於 Annotation 項目：</span><span class="sxs-lookup"><span data-stu-id="5f10d-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="5f10d-684">Annotation 項目不能存在於保留供 SSDL 使用的任何 XML 命名空間中。</span><span class="sxs-lookup"><span data-stu-id="5f10d-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="5f10d-685">任兩個 Annotation 項目的完整名稱不能相同。</span><span class="sxs-lookup"><span data-stu-id="5f10d-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="5f10d-686">Annotation 項目必須出現在所指定 SSDL 項目的所有其他子項目之後。</span><span class="sxs-lookup"><span data-stu-id="5f10d-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="5f10d-687">多個 Annotation 項目可以同時做為所指定 SSDL 項目的子系。</span><span class="sxs-lookup"><span data-stu-id="5f10d-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="5f10d-688">從 .NET Framework 第4版開始，您可以在執行時間使用 system.servicemodel 命名空間中的類別來存取 annotation 元素中包含的中繼資料。</span><span class="sxs-lookup"><span data-stu-id="5f10d-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="5f10d-689">範例</span><span class="sxs-lookup"><span data-stu-id="5f10d-689">Example</span></span>

<span data-ttu-id="5f10d-690">下列範例顯示具有 annotation 元素（**CustomElement**）的 EntityType 專案。</span><span class="sxs-lookup"><span data-stu-id="5f10d-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="5f10d-691">此範例也會顯示套用至 [**訂單**] 屬性的 annotation 屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="5f10d-692">Facet (SSDL)</span><span class="sxs-lookup"><span data-stu-id="5f10d-692">Facets (SSDL)</span></span>

<span data-ttu-id="5f10d-693">存放結構定義語言 (SSDL) 中的 Facet 表示 Property 項目中指定之資料行類型上的條件約束。</span><span class="sxs-lookup"><span data-stu-id="5f10d-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="5f10d-694">Facet 會實作為**屬性**元素上的 XML 屬性。</span><span class="sxs-lookup"><span data-stu-id="5f10d-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="5f10d-695">下表說明 SSDL 中支援的 Facet：</span><span class="sxs-lookup"><span data-stu-id="5f10d-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="5f10d-696">Facet</span><span class="sxs-lookup"><span data-stu-id="5f10d-696">Facet</span></span>           | <span data-ttu-id="5f10d-697">描述</span><span class="sxs-lookup"><span data-stu-id="5f10d-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f10d-698">**定序**</span><span class="sxs-lookup"><span data-stu-id="5f10d-698">**Collation**</span></span>   | <span data-ttu-id="5f10d-699">在執行比較和排序屬性值的作業時，指定要使用的定序順序 (或排序順序)。</span><span class="sxs-lookup"><span data-stu-id="5f10d-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="5f10d-700">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="5f10d-700">**FixedLength**</span></span> | <span data-ttu-id="5f10d-701">指定資料行值的長度是否可以變更。</span><span class="sxs-lookup"><span data-stu-id="5f10d-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="5f10d-702">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="5f10d-702">**MaxLength**</span></span>   | <span data-ttu-id="5f10d-703">指定資料行值的最大長度。</span><span class="sxs-lookup"><span data-stu-id="5f10d-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="5f10d-704">**有效位數**</span><span class="sxs-lookup"><span data-stu-id="5f10d-704">**Precision**</span></span>   | <span data-ttu-id="5f10d-705">針對**Decimal**類型的屬性，指定屬性值可以擁有的位數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="5f10d-706">針對**Time**、 **DateTime**和**DateTimeOffset**類型的屬性，指定資料行值的秒數小數部分的位數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="5f10d-707">**調整**</span><span class="sxs-lookup"><span data-stu-id="5f10d-707">**Scale**</span></span>       | <span data-ttu-id="5f10d-708">指定資料行值小數點右邊的位數。</span><span class="sxs-lookup"><span data-stu-id="5f10d-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="5f10d-709">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="5f10d-709">**Unicode**</span></span>     | <span data-ttu-id="5f10d-710">指定資料行值是否儲存為 Unicode。</span><span class="sxs-lookup"><span data-stu-id="5f10d-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
