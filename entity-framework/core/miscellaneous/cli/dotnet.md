...
|              |                                                                                              |
|:-------------|:---------------------------------------------------------------------------------------------|
| \<MIGRATION> | 在目標移轉。 如果為 0，就會還原所有移轉。 預設的最後一個移轉。 |
...
|    |                  |                                                                    |
|:---|:-----------------|:-------------------------------------------------------------------|
| -o | --output <FILE> | 若要將結果寫入檔案。                                   |
| -i | --idempotent	     | 產生的指令碼，可用在任何移轉的資料庫。 |
