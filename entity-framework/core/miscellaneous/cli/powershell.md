...
| -CoNtextDir \< 字串>              | 要放置檔案的目錄 `DbContext` 。 路徑相對於專案目錄。                                                                                                                                                               |
| -Namespace \< 字串>               | 要用於所有產生之類別的命名空間。 預設為從根命名空間和輸出目錄產生。                                                                                                                                                                                             |
| -CoNtextNamespace \< 字串>        | 要用於所產生類別的命名空間 `DbContext` 。 注意：覆寫 `-Namespace` 。                                                                                                                                                                              |
| -內容 \< 字串>                 | `DbContext`要產生的類別名稱。                                                                                                                                                                                                                          |
...
| 參數                | 說明                                                                                                                                                                                                                |
|:-------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *-來源* \<字串>        | 開始的遷移。 可以依名稱或識別碼來識別遷移。 數位0是特殊案例，表示*第一次遷移之前*。 預設為 0。                                                              |
| *-至* \<字串>          | 結束遷移。 預設為上次遷移。                                                                                                                                                                      |
...
| <nobr>-連接 \< 字串></nobr>  | 資料庫的連接字串。 預設為或中指定的 `AddDbContext` 值 `OnConfiguring` 。 |
