...
> [!TIP]
> 您可以在 GitHub 上查看本文[的範例](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/QueryFilters)。
...
> [!NOTE]
> 當前無法在同一實體上定義多個查詢篩選器 -僅應用最後一個查詢篩選器。 但是,您可以使用邏輯_AND_運算符號 ([`&&`在 C#)](https://docs.microsoft.com/dotnet/csharp/language-reference/operators/boolean-logical-operators#conditional-logical-and-operator-)定義具有多個條件的單個篩選器。
