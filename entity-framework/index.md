...
ms.locfileid: "78412913"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Entity Framework 文件</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="entityfmwk1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Entity Framework 是一種物件關聯式對應程式 (O/RM)，可讓 .NET 開發人員使用 .NET 物件來處理資料庫。 它不需要開發人員通常需要撰寫的大部分資料存取程式碼。</p>
                                </div>
                            </li>
                            <li>
                                <a href="/ef/core/">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>EF Core 是 Entity Framework 的輕量型、可擴充且跨平台版本。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>EF 6 是已經過試用並測試的資料存取技術，具有多年的功能和穩定性。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/ef/core/modeling/">建立模型</a>
                                                </p>
                                                <p>
                                                    <a href="/ef/core/querying/">查詢資料</a>
                                                </p>
                                                <p>
                                                    <a href="/ef/core/saving/">儲存資料</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/ef/core/providers/">資料庫提供者</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://docs.microsoft.com/dotnet/api/?view=efcore-2.1">API 參考</a>
                                                </h3>
                                                <p>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/dotnet/api/?view=efcore-2.1">其他...</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>開始使用</h3>
                                                    <p>了解如何使用 Entity Framework 6 存取資料。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>應用程式開發介面參考</h3>
                                                    <p>瀏覽依命名空間組織的 Entity Framework 6 API。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
